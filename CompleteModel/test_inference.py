...
boxes, classes, img_indices = ObjectDetectionModel('./ObjectDetection/exported_models/ssd_resnet101_640_v11/saved_model')(images).values()

boxes = MergeBoxes(src_size=640)(boxes, img_indices, offsets, sub_size)
