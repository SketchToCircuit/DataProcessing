...
class Potentiometer(IPinDetection):
    ...
    def get_pins(lines: np.ndarray, centroid: np.ndarray, img_size: np.ndarray):
        ...
        below_c = diagonal_lines[:, :, 1] > centroid[1]
        ...
        if np.count_nonzero(mask) > 0:
            ...
            # shift centroid to the left and flip vertical
            # scale lines horizontally to make diagonal line mor vertical
            centroid[0] = centroid[0] - img_size[1] / 5
            centroid[1] = img_size[0] - centroid[1]
